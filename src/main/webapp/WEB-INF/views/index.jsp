				...
				if (data == 1) {
					...
					$.ajax({
						...
						success : function(data) {
							...
							//하나만 붙이기						
							console.log(result[0][0].value, result[0][1].value,
									result[0][2].value);
							refreshChat(result[0][0].value, result[0][1].value,
									result[0][2].value);
							$('#chatList').scrollTop(
...
<%=request.getAttribute("result")%>
	//JSP 스크립트 태그
		...
		for (var i = 0; i < result.length; i++) {
			console.log(result[i][0].value, result[i][1].value,
					result[i][2].value);
...
<body>
	...
	<div class="container">
					...
					<div class="portlet portlet-blue">
						...
						<div id="chat" class="panel-collapse collapse in">
							...
							<div id="chatList" class="portlet-body chat-widget"
								style="overflow-y: scroll; width: auto; height: 430px;"></div>
								...
								<div class="row">
									<div class="form-group col-xs-4">
										<input style="height: 40px;" type="text" id="chatName"
											onkeyup="choHangul(this.value)" class="form-control"
								...
								<div class="row" style="height: 90px">
									<div class="form-group col-xs-10">
										<textarea style="height: 80px;" id="chatContent"
											onkeyup="choHangul(this.value)" class="form-control"
											placeholder="한글 문자열을 입력하여 주세요." maxlength="100"></textarea>
									</div>
									<div class="form-group col-xs-2">
										<button type="button" class="btn btn-warning pull-right" style="height: 80px;"
		...
		<div class="alert alert-success" id="successMessage"
			style="display: none;">
			<strong>초성으로 변환시켰습니다.</strong>
		</div>
		<div class="alert alert-danger" id="dangerMessage"
			style="display: none;">
			<strong>초성으로 변환시키지 못했습니다. 한글 문자열을 입력하여 주세요.</strong>
		</div>
